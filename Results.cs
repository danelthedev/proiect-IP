    ...
    public partial class Results : Form
    {
        ...
        private void CreateDynamicInterface(int number)
        {
            ...
            for(index = 1; index <= number; ++index)
            {
                ...
                //Label Period
                LabelReference labelRacePeriodCopy = new LabelReference(labelResultsRacePeriod1, index);
                ...
                //Label 1st Place
                LabelReference label1stPlayerCopy = new LabelReference(labelResults1stPlayer1, index);
                ...
                //Label 2nd Place
                LabelReference label2ndPlayerCopy = new LabelReference(labelResults2ndPlayer1, index);
                ...
                //Label 3rd Place
                LabelReference label3rdPlayerCopy = new LabelReference(labelResults3rdPlayer1, index);
                ...
                PictureBoxReference pictureBox1stCopy = new PictureBoxReference(pictureBoxResults1st1, index);
                ...
                PictureBoxReference pictureBox2ndCopy = new PictureBoxReference(pictureBoxResults2nd1, index);
                ...
                PictureBoxReference pictureBox3rdCopy = new PictureBoxReference(pictureBoxResults3rd1, index);
